...
test(
  ...
  () => {
    ...
    expect(packedFiles.has('template/src/main.tsx')).toBe(true)
    expect(packedFiles.has('template/src/index.css')).toBe(true)
    ...
    expect(packedFiles.has('template/src/components/theme-provider.tsx')).toBe(false)
    expect(packedFiles.has('template/src/assets/react.svg')).toBe(false)
    expect(packedFiles.has('template/public/vite.svg')).toBe(false)
